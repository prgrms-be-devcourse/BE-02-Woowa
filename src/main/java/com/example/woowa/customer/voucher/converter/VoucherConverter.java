...
public class VoucherConverter {
    ...
    public static Voucher toVoucher(VoucherCreateRequest voucherCreateRequest) throws Exception {
        VoucherType voucherType = EnumFindable.find(voucherCreateRequest.getVoucherType(),
            VoucherType.values());
        EventType eventType = EnumFindable.find(voucherCreateRequest.getEventType(),
            EventType.values());
        LocalDateTime localDateTime = LocalDateTime.parse(voucherCreateRequest.getExpirationDate(),
