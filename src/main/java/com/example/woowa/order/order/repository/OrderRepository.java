...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query(value = "SELECT new com.example.woowa.order.order.dto.statistics.OrderStatistics(count(o), coalesce(sum(o.orderPrice), 0), coalesce(sum(o.voucherDiscountPrice), 0), coalesce(sum(o.usedPoint), 0)) FROM Order o WHERE o.restaurant = :restaurant AND o.delivery.deliveryStatus = :deliveryStatus AND o.createdAt BETWEEN :from AND :end")
